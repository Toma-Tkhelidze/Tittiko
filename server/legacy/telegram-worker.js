/* ============================================================================
   ტიტიკო — Telegram proxy (Cloudflare Worker)  —  ⚠️ ჩანაცვლებულია
   ============================================================================

   ეს არის ის Worker, რომელიც ამჟამად ცოცხალია (shy-sound-1c56) — შეკვეთას
   პირდაპირ Telegram-ში აგზავნის, გადახდის გარეშე. საბოლოო ვერსია, სადაც
   გადახდაც არის ჩაშენებული, არის server/worker.js — მასზე გადართვისას ეს
   ფაილი მხოლოდ ისტორიისთვის რჩება რეპოზიტორიაში.
